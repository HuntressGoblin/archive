<div class="callout-section" data-theme="notenpc1" style="text-align:center;">
    <!-- NAME -->
    <div class="callout-title"><i class="fa-solid fa-axe-battle"></i>Thralla<i class="fa-solid fa-axe-battle"></i></div>
    <!-- TITLE / Subtitle -->
    <div style="font-style:italic; margin-bottom:6px;">A No-nonsense Ally</div>
    <!-- PICTURE -->
    <img src="Orcscomeinmanyshapesandsizesandattitudes.png" alt="Thrallapic">
</div>
...
<div class="callout-section info-box" data-theme="notenpc1">
    ...
    <div><a class="internal-link" href="To be a Trailblazer">Trailblazer Party:</a> They're fairly competent and have been taking good care of others here.</div>
