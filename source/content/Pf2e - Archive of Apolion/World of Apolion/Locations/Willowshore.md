<div class="willowshorefigure3-wrapper">
    <div class="ws3-header">
    <span class="ws3-talisman">霊封</span>
        <h1 class="ws3-title"><i class="fa-slab fa-regular fa-flower"></i>Willowshore<i class="fa-slab fa-regular fa-flower"></i></h1>
        <span class="ws3-subtitle">The Quietest Town of Tian Xia - Settlement 4</span>
    </div>
    <div class="ws3-image-container">
        <img src="Willowshorepic1.png" alt="Willowshore1">
    </div>
    <div class="ws3-content">
        <h3><i class="fa-slab fa-regular fa-flower"></i>Overview<i class="fa-slab fa-regular fa-flower"></i></h3>
        <p>
...
> [[Shenmen]], [[Southridge]], [[Northridge]], [[Tan Sugi Monastery]].