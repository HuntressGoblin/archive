...
<div class="bookshelf">
  <div class="shelf">
    ...
    <div class="book tall walnut">
      ...
      <div class="blurb"><b>Symbol Guide<br>(Make sure you refresh to see the symbols if they don't appear.)</b><br><i class="fa-solid fa-arrow-up-right-from-square"></i> This icon shows that clicking on the picture near it will take you somewhere else!</div>
    </div>
